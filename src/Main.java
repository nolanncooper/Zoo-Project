...
public class Main {
	...
	public static void intro() {
		...
		System.out.println("It is your job to develop and build your zoo from a simple petting zoo, to a state-of-the-art animal habitat. Each time you collect items fro an animal it ages.");
	...
	public static void newAnimals() {
		...
		System.out.println("Zebra = $" + ((100-zeb.getHungerValue())/4));
		 str = stringInput.nextLine();
		System.out.println();
		System.out.println("The income each animal bring in per day: ");
